    ...
    <>
      ...
      {!isLoading && (
        <div className="mt-5">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex items-center gap-2 mb-5">
                <span
                  ...
                  className={`flex items-center justify-center p-1 border rounded-full cursor-pointer md:p-3 border-contentSecond ${
                ...
                >
                  <i
                    className={`text-sm md:text-base bx ${
                      isFavorite(movie.slug) ? "bxs-heart" : "bx-plus"
                    }`}
                  ></i>
                </span>
                <span className="text-sm font-bold md:text-base">
                  {isFavorite(movie.slug) ? "ĐÃ YÊU THÍCH" : "YÊU THÍCH"}
                </span>
              </div>
          ...
          {/* Comment Section */}
          <CommentSection movieId={movie.slug} movieName={movie.name} />
        </div>
      )}
    </>
  );
